...
if(isset($_POST['submit'])){
    ...
    $checkEmailSelect = "select email from adminlogindb where email = '$email'";
    ...
    if($row == 0){ // current email is not exist in db
        ...
        $datInsert = "insert into adminlogindb(`userName`, `email`, `password`, `status`, `date`, `time`) VALUES ('$userName','$email','$pass_hashing','$status','$date','$time')";
...
<head>
    ...
    <title>Admin Registration || RushDrive Service</title>
        ...
        <div class="secondHalf">
            <form action="#" method="post">           
                ...
                <div class="container1">
                    <h1>Registration - Admin Panel</h1><br>
