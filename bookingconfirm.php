...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
    ...
    <h2 class="text-center"> Thank you for using RushDrive System! We wish you have a safe ride. </h2>
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <div class="col-md-10" style="float: none; margin: 0 auto; ">
                ...
                <br>
                <h4> <strong>Agency Name:</strong>  <?php echo $client_name; ?></h4>
                <br>
                <h4> <strong>Agency Contact: </strong> <?php echo $client_phone; ?></h4>
                <br>
            </div>
        </div>
