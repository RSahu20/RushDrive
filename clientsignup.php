...
<head>
    <title> Agency Signup | RushDrive  </title>
</head>
...
<body>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center">RushDrive - Registration</h1>
            <br>
            <p class="text-center">Get started by creating an Agency account</p>
        </div>
    </div>
        ...
        <div class="col-md-5 col-md-offset-4">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="Registered_success.php" method="POST">
...
<footer class="site-footer">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6">
                <h5>© <?php echo date("Y"); ?> RushDrive</h5>
            </div>
        </div>
    </div>
</footer>
